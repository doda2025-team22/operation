...
3. Run `ansible-playbook -u vagrant -i 192.168.56.100, finalization.yaml` inside /ansible to deploy the kubernetes dashboard and ingress-nginx.
4. Run `kubectl get nodes` to see the nodes in the cluster.
